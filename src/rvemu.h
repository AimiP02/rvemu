...
enum inst_type_t {
    inst_lb, inst_lh, inst_lw, inst_ld, inst_lbu, inst_lhu, inst_lwu, // done
    inst_fence, inst_fence_i, // done
    inst_addi, inst_slli, inst_slti, inst_sltiu, inst_xori, inst_srli, inst_srai, inst_ori, inst_andi, inst_auipc, inst_addiw, inst_slliw, inst_srliw, inst_sraiw, // done
    inst_sb, inst_sh, inst_sw, inst_sd, // done
    inst_add, inst_sll, inst_slt, inst_sltu, inst_xor, inst_srl, inst_or, inst_and, //done
    inst_mul, inst_mulh, inst_mulhsu, inst_mulhu, inst_div, inst_divu, inst_rem, inst_remu, // done
    inst_sub, inst_sra, inst_lui, // done
    inst_addw, inst_sllw, inst_srlw, inst_mulw, inst_divw, inst_divuw, inst_remw, inst_remuw, inst_subw, inst_sraw, // done
    inst_beq, inst_bne, inst_blt, inst_bge, inst_bltu, inst_bgeu, // done
    inst_jalr, inst_jal, inst_ecall, // done
    inst_csrrc, inst_csrrci, inst_csrrs, inst_csrrsi, inst_csrrw, inst_csrrwi, // done
    inst_flw, inst_fsw, // done
    inst_fmadd_s, inst_fmsub_s, inst_fnmsub_s, inst_fnmadd_s, inst_fadd_s, inst_fsub_s, inst_fmul_s, inst_fdiv_s, inst_fsqrt_s, // done
    inst_fsgnj_s, inst_fsgnjn_s, inst_fsgnjx_s,
    inst_fmin_s, inst_fmax_s, // done
    ...
    inst_fld, inst_fsd, // done
    inst_fmadd_d, inst_fmsub_d, inst_fnmsub_d, inst_fnmadd_d,
    inst_fadd_d, inst_fsub_d, inst_fmul_d, inst_fdiv_d, inst_fsqrt_d, // done
    inst_fsgnj_d, inst_fsgnjn_d, inst_fsgnjx_d,
    inst_fmin_d, inst_fmax_d, // done
